...
class ProductPage(BasePage):
    ...
    @allure.step('Add an item to the basket')
    def add_good_to_basket(self):
        add_button = self.browser.find_element(*ProductPageLocators.ADD_TO_BASKET_BUTTON)
        add_button.click()

    @allure.step('Check there is message about successful adding an item to the basket')
    ...
    @allure.step('Check that book name in the basket equal to name of adding book')
    ...
    @allure.step('Check that book price in the basket equal to name of adding price')
    ...
    @allure.step('Check there is no success message ')
    def should_not_be_success_message(self):
        assert self.is_not_element_present(*ProductPageLocators.SUCCESS_MESSAGE), \
            "Success message is presented, but should not be"

    @allure.step('Check element is disappeared')
    ...
    @allure.step('Check there is no item')
    def should_not_be_element(self):
        assert self.is_not_element_present(*ProductPageLocators.ADDED_BOOK_NAME), "Element is presented"
